...
% solutionsatend = move exercise and activity solutions to location of \printexercisesolutions and \printactivitysolutions
...
\marginnote{Hello}
\end{highlight}
\[%use aligned within \[\] instead of align* here as the latter leaves a gap
\begin{aligned}
y &=x\\
...
\end{style4box}
\lipsum[133]
\begin{style2box}[Figure within a Box]
\begin{figure}
...
\begin{quote}
\lipsum[133]
\sourcereference{adapted from Cicero, \itemrights{unknown}}
\end{quote}
...
\lipsum[2]
\begin{exercise}
The use of \verb"enumerate" lists to denote subexercises is not helpful when the question needs to contain a genuine enumerated list. For this exceptional case the \verb"plainenumerate" environment can be used as follows.
\begin{plainenumerate}
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
\end{plainenumerate}
\begin{solution}
Sometimes a solution needs to include an enumerated list, which is distinct from the enumerated list used to denote subquestions.
\begin{plainenumerate}
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
\item Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah Blah.
...
\end{solution}
\end{activity}
\begin{activity}[Another activity with a very, very, very, very, very, very, very, very, very, very, very, very, very, very, very, very, very, very, very, very long title]
\lipsum[133]
\begin{solution}
\lipsum[133]
\end{solution}
...
Use \verb"\tikz{}"for inline Tikz figures  \tikz{\draw[thin] (0:0.15) -- (60:0.15) -- (120:0.15) -- (180:0.15) -- (240:0.15) -- (300:0.15) --cycle;}
...
\begin{widefigure}[needspace=2.5in]%gives hint to page breaking algorithm
...
A second voice is available to add comments to show what you are thinking. \thinks{Example thought bubble}.
