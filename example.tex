...
\newcounter{theorem}
\newenvironment{theorem}[1][]{\refstepcounter{theorem}\begin{style2box}[\twoparttitle{Theorem \thetheorem\quad}{#1}]}{\end{style2box}}
...
\makefrontpages
\introduction
\lipsum[133]\authorcomment{testing 1,2,3}
\[
E=mc^2
\]
\lipsum[133]
...
Use \verb"\includegraphics" for inline figures \includegraphics{media/icon.png}.
